...
Regla de oro: la plataforma jamás infiere ni fusiona identidades automáticamente por nombre o similitud.
    ...
    • El jugador real busca y solicita "reclamar" su perfil puente desde la app, O el capitán o coach/entrenador envía una invitación de vinculación.
...
5.4.1 Límites de plantilla por deporte
Cada deporte tiene un mínimo y máximo de jugadores por plantilla definido en su metadata. El organizador puede ajustar esos valores al configurar el torneo, pero no puede ir por debajo del mínimo absoluto del deporte.
Deporte	Mínimo default	Máximo default	Notas
Fútbol	11	25	Incluye portero
Fútbol 7	7	18	—
Básquetbol	5	15	—
Béisbol	9	25	—
Voleibol	6	14	—

⚠ Los valores exactos por deporte se configuran en sports.metadata y pueden ajustarse sin migración. La tabla anterior es referencia inicial.
...
Plan	Precio mensual	Precio anual	Límite clave	Feature diferenciador principal
Free (Permanente)	$0	$0	2 torneos simultáneos activos	Liga básica todos-contra-todos, modo express, perfiles puente ilimitados, control de pagos en efectivo
Starter	$400 MXN/mes	$3,840 MXN/año (−20%)	3 torneos simultáneos, equipos ampliados	Eliminación directa, playoffs, gestión de sedes con horarios automatizados
Pro	$600 MXN/mes	$5,760 MXN/año (−20%)	Torneos, categorías e inscripciones ilimitadas	Modo Mundial, motor de elegibilidad estricto, estadísticas avanzadas, pagos digitales, histórico vivo, Team Landing Pages
Elite / Enterprise	$1,000 MXN/mes	$9,600 MXN/año (−20%)	Ilimitado + corporativo	Sub-administradores, personalización visual, soporte prioritario, módulo entrenamientos (futuro)

⚠ Los planes se cobran por organización, no por usuario. No se penaliza al organizador por hacer crecer su comunidad.
⚠ Precios de trabajo definidos en sesión interna. Sujetos a ajuste antes de Beta pública (Hito 5).
...
referee_session_token en matches	Árbitros y organizadores delegados acceden al registro de eventos por link con token, sin necesidad de cuenta. Acceso estrictamente limitado al partido asignado. El capitán y el coach no tienen acceso a registro de eventos durante el partido.
...
13.3 Seguridad
    ...
    • Los tokens de árbitro y organizador delegado (referee_session_token) tienen acceso limitado estrictamente al partido asignado. Solo árbitro u organizador pueden registrar eventos — el capitán y el coach no tienen este acceso.
...
14. Decisiones de Producto — Resueltas
Los siguientes puntos fueron identificados durante la sesión de discovery y quedaron resueltos en sesión posterior. Se documentan aquí como registro de decisión.
#	Tema	Decisión	Impacto
1	¿El historial público requiere cuenta o es acceso libre?	Acceso libre sin cuenta, controlado por el organizador. Si el organizador configura el torneo como público, cualquier visitante puede ver resultados, campeones y estadísticas sin registrarse.	UX, auth, SEO
2	¿Quién puede iniciar la vinculación de un perfil puente?	Capitán, coach/entrenador, o el jugador mismo. Cualquiera de los tres puede iniciar el proceso; la vinculación requiere confirmación del otro lado para ejecutarse.	Flujo de onboarding
3	Suspensiones: ¿alcance por torneo o por plataforma?	Solo por torneo. Una sanción en un torneo no afecta la elegibilidad del jugador en otros torneos, ni siquiera dentro de la misma organización.	Motor de elegibilidad
4	¿Mínimo y máximo de jugadores en plantilla?	Sí existen límites, definidos por deporte. Cada deporte tiene defaults configurables (min/max) en su metadata. El organizador puede ajustar esos valores al configurar su torneo.	Validación de inscripción
5	¿Quién puede registrar eventos en partido?	Árbitro u organizador. El coach/entrenador y el capitán no tienen acceso a registro de eventos durante el partido. El acceso se otorga mediante un link con token (sin necesidad de cuenta), usando el mismo mecanismo de referee_session_token ya existente en el sistema.	Roles y permisos en vivo
6	Precios de planes en MXN	Starter $400/mes · Pro $600/mes · Elite $1,000/mes. Descuento anual del 20%: Starter $3,840/año · Pro $5,760/año · Elite $9,600/año. Precios de trabajo sujetos a ajuste antes de Beta pública.	Monetización, onboarding
